...
def run(args):
    ...
    # CAPITALIZATION_DATE is only required for FIXED_ASSET rows; Other Asset
    # rows (ASSET_TYPE = 'OTHER_ASSET') are never capitalized/depreciated.
